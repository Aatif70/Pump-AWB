...
class ApiConstants {
  ...
  static const String supplierEndpoint = "/api/Suppliers";
  static const String supplierByPumpEndpoint = "/api/Suppliers/ByPump";
  ...
  static String getCheckInUrl() {
    ...
    debugPrint('API_CONSTANTS: Check-in URL: $url');
    return url;
  }
  ...
  static String getCheckOutUrl() {
    ...
    debugPrint('API_CONSTANTS: Check-out URL: $url');
    return url;
  }
  ...
  static String getAttendanceByEmployeeUrl(String employeeId) {
    ...
    debugPrint('API_CONSTANTS: Attendance By Employee URL: $url');
    return url;
  }
  ...
  static String getActiveAttendanceUrl(String employeeId) {
    ...
    debugPrint('API_CONSTANTS: Active Attendance URL: $url');
    return url;
  }
  ...
  static String getIsCheckedInUrl(String employeeId) {
    ...
    debugPrint('API_CONSTANTS: Is Checked In URL: $url');
    return url;
  }
  ...
  static String getDailyAttendanceUrl(String petrolPumpId, DateTime date) {
    ...
    debugPrint('API_CONSTANTS: Daily Attendance URL: $url');
    return url;
  }
  ...
  static String getDailyAttendanceReportUrl(String petrolPumpId, DateTime date) {
    ...
    debugPrint('API_CONSTANTS: Daily Attendance Report URL: $url');
    return url;
  }
  ...
  static String getLateArrivalsUrl(String petrolPumpId, DateTime date) {
    ...
    debugPrint('API_CONSTANTS: Late Arrivals URL: $url');
    return url;
  }
  ...
  static String getUpdateShiftUrl(String shiftId) {
    ...
    debugPrint('API_CONSTANTS: Update Shift URL for ID $shiftId: $url');
    return url;
  }
  ...
  static String getDeleteShiftUrl(String shiftId) {
    ...
    debugPrint('API_CONSTANTS: Delete Shift URL for ID $shiftId: $url');
    return url;
  }
  ...
  static String getFuelDispenserByIdUrl(String id) {
    ...
    debugPrint('API_CONSTANTS: Fuel Dispenser by ID URL: $url');
    return url;
  }
  ...
  static String getFuelDispenserByPetrolPumpIdUrl(String petrolPumpId) {
    ...
    debugPrint('API_CONSTANTS: Fuel Dispenser by Petrol Pump ID URL: $url');
    return url;
  }
  ...
  static String getUpdateFuelDispenserUrl() {
    ...
    debugPrint('API_CONSTANTS: Update Fuel Dispenser URL: $url');
    return url;
  }
  ...
  static String getNozzleUrl() {
    ...
    debugPrint('API_CONSTANTS: Nozzle URL: $url');
    return url;
  }
  ...
  static String getNozzleUrlWithFuelTypeOverride() {
    ...
    debugPrint('API_CONSTANTS: Nozzle URL with fuel type override: $url');
    return url;
  }
  ...
  static String getNozzleByIdUrl(String id) {
    ...
    debugPrint('API_CONSTANTS: Nozzle by ID URL: $url');
    return url;
  }

  static String getNozzlesByDispenserUrl(String dispenserId) {
    if (dispenserId.isEmpty) {
      debugPrint('API_CONSTANTS: Warning - Empty dispenser ID provided for nozzle URL');
    ...
    debugPrint('API_CONSTANTS: Nozzles by Dispenser URL: $url');
    return url;
  }
  ...
  static String getSetPriceUrl() {
    ...
    debugPrint('DEBUG: Set Fuel Price API URL: $url');
    debugPrint('DEBUG: Pricing endpoint: $pricingEndpoint');
    return url;
  }
  ...
  static String getCurrentPricesUrl() {
    ...
    debugPrint('DEBUG: Current Prices API URL: $url');
    return url;
  }
  ...
  static String getCurrentPricesByPetrolPumpUrl(String petrolPumpId) {
    ...
    debugPrint('API_CONSTANTS: Current Prices by Petrol Pump URL: $url');
    return url;
  }
  ...
  static String getPriceByIdUrl(String priceId) {
    ...
    debugPrint('DEBUG: Get Price By ID API URL: $url');
    debugPrint('DEBUG: Price ID: $priceId');
    return url;
  }
  ...
  static String getDeletePriceUrl(String priceId) {
    ...
    debugPrint('DEBUG: Delete Price API URL: $url');
    debugPrint('DEBUG: Deleting Price ID: $priceId');
    return url;
  }
  ...
  static String getUpdatePriceUrl(String priceId) {
    ...
    debugPrint('DEBUG: Update Price API URL: $url');
    debugPrint('DEBUG: Updating Price ID: $priceId');
    return url;
  }
  ...
  static String getLatestPriceByFuelTypeUrl(String fuelType) {
    ...
    debugPrint('API_CONSTANTS: Latest Price by Fuel Type URL: $url');
    return url;
  }
  ...
  static String getFuelPriceByNozzleUrl(String nozzleId) {
    ...
    debugPrint('API_CONSTANTS: Fuel Price by Nozzle URL: $url');
    return url;
  }
  ...
  static String getPriceHistoryByFuelTypeUrl(String fuelType, {String? fuelTypeId}) {
    ...
    debugPrint('DEBUG: Price History API URL: $url');
    debugPrint('DEBUG: Using fuelTypeId: $fuelTypeId');
    return url;
  }
  ...
  static String getNozzleReadingSubmitUrl() {
    ...
    debugPrint('API_CONSTANTS: Nozzle Reading Submit URL: $url');
    return url;
  }
  ...
  static String getNozzleReadingsByEmployeeUrl(String employeeId) {
    ...
    debugPrint('API_CONSTANTS: Nozzle Readings By Employee URL: $url');
    return url;
  }
  ...
  static String getNozzleReadingsByNozzleIdUrl(String nozzleId) {
    ...
    debugPrint('API_CONSTANTS: Nozzle Readings By Nozzle ID URL: $url');
    return url;
  }
  ...
  static String getEmployeeShiftUrl() {
    ...
    debugPrint('API_CONSTANTS: Employee Shift URL: $url');
    return url;
  }
  ...
  static String getEmployeeShiftByIdUrl(String id) {
    ...
    debugPrint('API_CONSTANTS: Employee Shift by ID URL: $url');
    return url;
  }
  ...
  static String getDeleteEmployeeShiftUrl(String employeeShiftId) {
    ...
    debugPrint('API_CONSTANTS: Delete Employee Shift URL: $url');
    return url;
  }
  ...
  static String getEmployeesByShiftIdUrl(String shiftId) {
    ...
    debugPrint('API_CONSTANTS: Employees by Shift ID URL: $url');
    return url;
  }
  ...
  static String getEmployeeShiftsByShiftIdUrl(String shiftId) {
    ...
    debugPrint('API_CONSTANTS: Employee Shifts by Shift ID URL: $url');
    return url;
  }
  ...
  static String getShiftsByEmployeeIdUrl(String employeeId) {
    ...
    debugPrint('API_CONSTANTS: Shifts by Employee ID URL: $url');
    return url;
  }
  ...
  static String getAssignEmployeeToShiftUrl() {
    ...
    debugPrint('API_CONSTANTS: Assign Employee to Shift URL: $url');
    return url;
  }
  ...
  static String getShiftSalesByEmployeeUrl(String employeeId) {
    ...
    debugPrint('API_CONSTANTS: Shift Sales By Employee URL: $url');
    return url;
  }
  ...
  static String getSupplierUrl() {
    ...
    debugPrint('API_CONSTANTS: Supplier URL: $url');
    return url;
  }

  static String getSupplierByPumpUrl() {
    final url = baseUrl + supplierByPumpEndpoint;
    developer.log('Supplier By Pump URL: $url');
    debugPrint('API_CONSTANTS: Supplier By Pump URL: $url');
    return url;
  }
  ...
  //   debugPrint('API_CONSTANTS: Supplier by ID URL: $url');
  //   return url;
  // }
  ...
  static String getUpdateSupplierUrl(String supplierDetailId) {
    ...
    debugPrint('API_CONSTANTS: Update Supplier URL: $url');
    return url;
  }
  ...
  static String getDeleteSupplierUrl(String supplierDetailId) {
    ...
    debugPrint('API_CONSTANTS: Delete Supplier URL: $url');
    return url;
  }
  ...
  static String getFuelDeliveryUrl() {
    ...
    debugPrint('API_CONSTANTS: Fuel Delivery URL: $url');
    return url;
  }
  ...
  static String getFuelDeliveriesByPumpUrl() {
    ...
    debugPrint('API_CONSTANTS: Fuel Deliveries By Pump URL: $url');
    return url;
  }
  ...
  static String getFuelDeliveryByIdUrl(String fuelDeliveryId) {
    ...
    debugPrint('API_CONSTANTS: Fuel Delivery by ID URL: $url');
    return url;
  }
  ...
  static String getUpdateFuelDeliveryUrl(String fuelDeliveryId) {
    ...
    debugPrint('API_CONSTANTS: Update Fuel Delivery URL: $url');
    return url;
  }
  ...
  static String getDeleteFuelDeliveryUrl(String fuelDeliveryId) {
    ...
    debugPrint('API_CONSTANTS: Delete Fuel Delivery URL: $url');
    return url;
  }
  ...
  static String getShiftSalesReportUrl(DateTime startDate, DateTime endDate) {
    ...
    debugPrint('API_CONSTANTS: Shift Sales Report URL: $url');
    return url;
  }
  ...
  static String getEmployeePerformanceReportUrl(DateTime startDate, DateTime endDate, String employeeId) {
    ...
    debugPrint('API_CONSTANTS: Employee Performance Report URL: $url');
    return url;
  }
  ...
  static String getStockMovementReportUrl(DateTime date) {
    ...
    debugPrint('API_CONSTANTS: Stock Movement Report URL: $url');
    return url;
  }
  ...
  static String getComprehensiveDailyReportUrl(DateTime date) {
    ...
    debugPrint('API_CONSTANTS: Comprehensive Daily Report URL: $url');
    return url;
  }
  ...
  static String getGovernmentTestingUrl() {
    ...
    debugPrint('API_CONSTANTS: Government Testing URL: $url');
    return url;
  }
  ...
  static String getGovernmentTestingByPumpUrl(String petrolPumpId) {
    ...
    debugPrint('API_CONSTANTS: Government Testing By Pump URL: $url');
    return url;
  }
  ...
  static String getPumpProfileUrl(String pumpId) {
    ...
    debugPrint('API_CONSTANTS: Pump Profile URL: $url');
    return url;
  }
  ...
  static String getUpdatePumpProfileUrl(String pumpId) {
    ...
    debugPrint('API_CONSTANTS: Update Pump Profile URL: $url');
    return url;
  }
  ...
  static String getFuelTypesUrl() {
    ...
    debugPrint('API_CONSTANTS: Fuel Types URL: $url');
    return url;
  }
  ...
  static String getPumpFuelTypesUrl(String petrolPumpId) {
    ...
    debugPrint('API_CONSTANTS: Pump Fuel Types URL: $url');
    return url;
  }
  ...
  static String getFuelTypeByPetrolPumpUrl() {
    ...
    debugPrint('API_CONSTANTS: Fuel Type by Petrol Pump URL: $url');
    return url;
  }
  ...
  static String getFuelQualityCheckUrl() {
    ...
    debugPrint('API_CONSTANTS: Fuel Quality Check URL: $url');
    return url;
  }
  ...
  static String getFuelQualityCheckByTankUrl(String fuelTankId) {
    ...
    debugPrint('API_CONSTANTS: Fuel Quality Check By Tank URL: $url');
    return url;
  }
  ...
  static String getCashReconciliationReportUrl(DateTime date, [String? shiftId]) {
    ...
    if (shiftId != null && shiftId.isNotEmpty) {
      ...
      url = '$baseUrl$cashReconciliationEndpoint?date=$formattedDate&shiftId=$shiftId';
      debugPrint('YAHAN GADBAD HAI');
    }
    
    developer.log('Cash Reconciliation Report URL: $url');
    debugPrint('API_CONSTANTS: Cash Reconciliation Report URL: $url');
    return url;
  }
  ...
  static String getShiftsByPetrolPumpUrl(String petrolPumpId) {
    ...
    debugPrint('API_CONSTANTS: Shifts by Petrol Pump URL: $url');
    return url;
  }
  ...
  static String getShiftsByPetrolPumpForReportingUrl(String petrolPumpId) {
    ...
    debugPrint('DEBUG: Daily Report - Shifts by Petrol Pump URL: $url');
    ...
    debugPrint('DEBUG: Alternative URL formats:');
    debugPrint('DEBUG: Format 1: $altUrl1');
    debugPrint('DEBUG: Format 2: $altUrl2');
    debugPrint('DEBUG: Format 3: $altUrl3');
